...
export class ClientManagerComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.project1 = {
      IsDeleted: false, RequestOpenedLength: 0, RequestInProgressLength: 0,RequestApproveLength:0,RequestDoneLength:0,RequestRejectLength:0,RequestSystemClosedLength:0,RequestWaitingApproveLength:0, RequestClosedLength: 0,
