...
export class AllProjectsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.project1 = {startDate:new Date,endtDate:new Date,
      IsDeleted: false, RequestClosedLength: 0, RequestInProgressLength: 0, RequestOpenedLength: 0,RequestApproveLength:0,RequestDoneLength:0,RequestRejectLength:0,RequestSystemClosedLength:0,RequestWaitingApproveLength:0,
