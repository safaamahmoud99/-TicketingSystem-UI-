...
console.log("selectedSitesColumns ccccc",this.selectedSitesColumns)

        // this.selectedSitesColumns.forEach(element => {
        //   this.numberss.push(element.id);
        // });
        ...
        // });
       // console.log("numbers",this.numberss) 
