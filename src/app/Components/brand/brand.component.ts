...
export class BrandComponent implements OnInit {
  ...
  constructor(private BrandService:BrandService, private router: Router, private confirmationService: ConfirmationService, private messageService: MessageService,private http : HttpClient
  ...
  NewDialog() {
    ...
    let body = {
      ...
      "sender":"Almostakbal",
      "Mobile":"01208890137",
      "message":"hello Esraa from sms misr"
  
  };
 console.log("body",body);
  return this.http.post('https://smsmisr.com/api/v2', body, { 
