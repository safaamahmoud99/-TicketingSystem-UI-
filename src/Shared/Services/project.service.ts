...
export class ProjectService {
  ...
  CountDoneProjects(projectId:number):Observable<any>{
    return this.httpClient.get<any>(`${environment.CountDoneProjects}${projectId}`,this.httpHeader);
  }
  CountWaitingApproveProjects(projectId:number):Observable<any>{
    return this.httpClient.get<any>(`${environment.CountWaitingApproveProjects}${projectId}`,this.httpHeader);
  }
  CountApproveProjects(projectId:number):Observable<any>{
    return this.httpClient.get<any>(`${environment.CountApproveProjects}${projectId}`,this.httpHeader);
  }
  CountRejectProjects(projectId:number):Observable<any>{
    return this.httpClient.get<any>(`${environment.CountRejectProjects}${projectId}`,this.httpHeader);
  }
  CountSystemClosedProjects(projectId:number):Observable<any>{
    return this.httpClient.get<any>(`${environment.CountSystemClosedProjects}${projectId}`,this.httpHeader);
  }
