...
export class PiechartComponent implements OnInit {
  ...
  RequestWaitingApproveLength: number
  RequestApproveLength: number
  RequestDoneLength: number
  RequestRejectLength: number
  RequestSystemClosedLength: number
      ...
      this.RequestStatus.forEach(element => {
        ...
        this.requestService.GetAllRequestByRequestStatus(element.id).subscribe(e => {
          if (element.status == 'Open') {
            ...
            this.RequestDoneLength = e.length
            console.log("this.RequestDoneLength",this.RequestInProgressLength)
          }
          else if (element.status == 'Waiting Approve') {
            this.RequestWaitingApproveLength = e.length
            console.log("RequestWaitingApproveLength",this.RequestInProgressLength)
          }
          else if (element.status == 'Approved') {
            this.RequestApproveLength = e.length
            console.log("this.RequestInProgressLength",this.RequestInProgressLength)
          }
          else if (element.status =='Rejected') {
            this.RequestRejectLength = e.length
            console.log("this.RequestInProgressLength",this.RequestInProgressLength)
          }
          else if (element.status == 'System Closed') {
            this.RequestSystemClosedLength = e.length
            console.log("this.RequestInProgressLength",this.RequestInProgressLength)
          }
            ...
            series: [
              {
                ...
                data: [this.RequestOpenLength, this.RequestClosedLength,
                   this.RequestInProgressLength,this.RequestDoneLength,this.RequestWaitingApproveLength,this.RequestApproveLength,
                   this.RequestRejectLength,this.RequestSystemClosedLength ]
              }
             ],
